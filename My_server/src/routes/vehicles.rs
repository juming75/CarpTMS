...
use crate::schemas::{PagedResponse, VehicleCreate as SchemaVehicleCreate, VehicleResponse, VehicleUpdate as SchemaVehicleUpdate};
...
pub async fn get_vehicles(
    ...
    // 4. 转换为 HTTP 响应
    let vehicle_responses: Vec<VehicleResponse> = vehicles
        .into_iter()
    ...
    Ok(success_response_with_message("车辆列表获取成功", paged_response))
}
...
pub async fn create_vehicle(
    ...
    info!("Vehicle created successfully: id={}, name={}", response.vehicle_id, response.vehicle_name);

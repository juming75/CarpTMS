...
use crate::domain::entities::location::{FenceCreate as DomainFenceCreate, FenceQuery as DomainFenceQuery, FenceUpdate as DomainFenceUpdate, LocationCreate as DomainLocationCreate, LocationUpdate as DomainLocationUpdate, PlaceCreate as DomainPlaceCreate, PlaceUpdate as DomainPlaceUpdate, RouteCreate as DomainRouteCreate, RouteUpdate as DomainRouteUpdate};
...
pub async fn create_fence(
    ...
    Ok(created_response_with_message("Fence created successfully", response))
}
...
pub async fn update_fence(
    ...
    // 调用服务更新围栏
    let updated_fence = location_service.update_fence(fence_id, domain_fence).await?;
...
pub async fn create_position(
    ...
    Ok(created_response_with_message("Location created successfully", response))
}
...
pub async fn update_position(
    ...
    // 调用服务更新位置
    let updated_location = location_service.update_location(location_id, domain_location).await?;
...
pub async fn create_place(
    ...
    Ok(created_response_with_message("Place created successfully", response))
}
...
pub async fn update_place(
    ...
    // 调用服务更新地点
    let updated_place = location_service.update_place(place_id, domain_place).await?;
...
pub async fn create_route(
    ...
    Ok(created_response_with_message("Route created successfully", response))
}
...
pub async fn update_route(
    ...
    // 调用服务更新路线
    let updated_route = location_service.update_route(route_id, domain_route).await?;

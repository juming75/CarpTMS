...
use crate::schemas::{DeviceStatistics, StatisticsResponse, VehicleStatistics, WeighingStatistics, StatisticsItem};
...
pub async fn get_vehicle_statistics(statistic_use_cases: web::Data<Arc<StatisticUseCases>>) -> AppResult<HttpResponse> {
...
pub async fn get_device_statistics(statistic_use_cases: web::Data<Arc<StatisticUseCases>>) -> AppResult<HttpResponse> {
    // 使用StatisticUseCases获取真实数据
    let query = StatisticQuery {
...
pub async fn get_safety_ranking(statistic_use_cases: web::Data<Arc<StatisticUseCases>>) -> AppResult<HttpResponse> {

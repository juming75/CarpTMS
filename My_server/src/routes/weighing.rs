...
use crate::application::services::weighing_data_service::{
    WeighingDataService, WeighingDataServiceImpl,
};
use crate::domain::entities::weighing_data::{
    WeighingDataCreate, WeighingDataQuery, WeighingDataUpdate,
};
use crate::errors::{
...
use crate::schemas::{
    PagedResponse, WeighingDataCreate as SchemaWeighingDataCreate, WeighingDataResponse,
    WeighingHistoryQuery,
};
...
pub async fn get_weighing_data(
    weighing_data_service: web::Data<Arc<WeighingDataServiceImpl>>,
    ...
    let (weighing_data, total_count) = weighing_data_service
        .get_weighing_data_list(domain_query)
        .await?;
...
pub async fn create_weighing_data(
    ...
    let created_data = weighing_data_service
        .create_weighing_data(domain_data)
        .await?;
...
pub async fn update_weighing_data(
    ...
    let updated_data = weighing_data_service
        .update_weighing_data(*id, domain_data)
        .await?;

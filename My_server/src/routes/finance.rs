...
use crate::domain::entities::finance::{
    FinanceCostQuery, FinanceInvoiceQuery, FinanceStatisticsQuery,
};
use crate::schemas::{
        ...
        Ok((costs, total)) => {
            ...
            let cost_responses: Vec<FinanceCostResponse> = costs
                ...
                .map(|cost| FinanceCostResponse {
                    ...
                    cost_date: cost.cost_date.format("%Y-%m-%d").to_string(),
...
pub async fn create_finance_cost(
    ...
    match finance_service
        .create_finance_cost(crate::domain::entities::finance::FinanceCostCreate {
        ...
        .await
    {
        Ok(cost) => {
            ...
            info!(
                "Finance cost created successfully: {}",
...
pub async fn update_finance_cost(
    ...
    match finance_service
        .update_finance_cost(
            cost_id,
            crate::domain::entities::finance::FinanceCostUpdate {
                cost_type: cost_data.cost_type,
                amount: cost_data.amount,
                description: cost_data.description,
                cost_date: cost_data.cost_date,
...
pub async fn create_finance_invoice(
    ...
    match finance_service
        .create_finance_invoice(crate::domain::entities::finance::FinanceInvoiceCreate {
...
pub async fn update_finance_invoice(
    ...
    match finance_service
        .update_finance_invoice(
            invoice_id,
            crate::domain::entities::finance::FinanceInvoiceUpdate {
                invoice_number: invoice_data.invoice_number,
                amount: invoice_data.amount,
                invoice_date: invoice_data.invoice_date,
                description: invoice_data.description,
...
pub async fn export_finance_data(
    _finance_service: web::Data<dyn FinanceService>,
) -> impl Responder {
    // 这里实现导出逻辑,暂时返回一个示例响应

...
pub mod container;
pub mod example;
pub use container::{Container, ContainerBuilder, Module, init_global_container, get_global_container, resolve, is_registered};
...
use crate::domain::use_cases::weighing_data::{WeighingDataRepository, WeighingDataUseCases};

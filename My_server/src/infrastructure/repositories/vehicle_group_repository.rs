...
use crate::domain::entities::vehicle_group::{VehicleGroup, VehicleGroupCreateRequest, VehicleGroupUpdateRequest, VehicleGroupTreeNode};
...
impl VehicleGroupRepository for PgVehicleGroupRepository {
    ...
    async fn find_all(&self, page: i32, page_size: i32) -> Result<(Vec<VehicleGroup>, i64), anyhow::Error> {
        ...
        let total_count = sqlx::query_scalar::<_, i64>(
            r#"SELECT COUNT(*) FROM vehicle_groups"#
        )
        .fetch_one(&*self.pool)
        .await?;

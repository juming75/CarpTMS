...
impl AuditLogRepository {
    ...
    pub async fn get_by_user_id(&self, user_id: i32, limit: i32, offset: i32) -> Result<Vec<AuditLog>> {
        let audit_logs = sqlx::query_as::<_, AuditLog>(
            r#"
            SELECT 
                id, 
    ...
    pub async fn get_by_resource_type(&self, resource_type: &str, limit: i32, offset: i32) -> Result<Vec<AuditLog>> {
        let audit_logs = sqlx::query_as::<_, AuditLog>(
            r#"
            SELECT 
                id, 

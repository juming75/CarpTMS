        ...
        <div v-loading="loading" class="table-container">
          ...
          >
            ...
            <template #column-actions="{ row }">
              <el-button type="primary" text size="small" @click="handleOrderView(row)">
                <el-icon><View /></el-icon>
                查看
              </el-button>
              <el-button type="success" text size="small" @click="handleOrderEdit(row)">
                <el-icon><Edit /></el-icon>
                编辑
              </el-button>
              <el-button type="danger" text size="small" @click="handleOrderDelete(row)">
...
// VirtualTable 列配置
const columns = ref<VirtualTableColumn<Order>[]>([
  ...
  { prop: 'totalAmount', label: '订单金额', width: 120, align: 'right' },
  { prop: 'actions', label: '操作', width: 180 },
]);
